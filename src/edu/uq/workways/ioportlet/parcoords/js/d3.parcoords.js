...
var events = d3.dispatch.apply(this,["render", "resize", "highlight", "brush", "brush_range"].concat(d3.keys(__))),
...
pc.brush = function() {
  ...
  __.brush_range = range_selected();
  events.brush_range.call(pc, __.brush_range);
  pc.render(); 
};
